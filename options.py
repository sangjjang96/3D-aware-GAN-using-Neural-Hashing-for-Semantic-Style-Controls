...
class BaseOptions():
    ...
    def initialize(self):
        ...
        dataset.add_argument("--data_path", type=str, default='./data/lmdb_celebamaskhq_512', help="path to the dataset")
        dataset.add_argument("--dataset_path", type=str, default='./data/CelebAMask-HQ/image_train_dilate/*.jpg', help="path to the dataset")
        dataset.add_argument("--mask_path", type=str, default='./data/CelebAMask-HQ/label_train_dilate/*.png', help="path to the mask dataset")
        ...
        training.add_argument("--checkpoints_dir", type=str, default='./checkpoints', help='checkpoints directory name')
        ...
        training.add_argument("--iter", type=int, default=500000, help="total number of training iterations")
        ...
        training.add_argument("--Semantic_D_lambda", type=float, default=1, help="weight of semantic-discriminator loss")
        training.add_argument("--r1_img", type=float, default=10, help="weight of the r1 regularization of img")
        training.add_argument("--r1_seg", type=float, default=1000, help="weight of the r1 regularization of seg")
        ...
        training.add_argument("--min_surf_lambda", type=float, default=0.001, help="weight of the minimal surface regularization")
        ...
        inference.add_argument("--semantics", type=str, default='', help='generate only some local semantics')
        inference.add_argument("--truncation_ratio", type=float, default=0.7, help="truncation ratio, controls the diversity vs. quality tradeoff. Higher truncation ratio would generate more diverse results")
        ...
        inference.add_argument("--flag", type=str, default='', help="set output name")

        # Generator options
        model = self.parser.add_argument_group('model')
        model.add_argument("--size", type=int, default=256, help="image sizes for the model")
        model.add_argument("--label_size", type=int, default=9, help="number of classes of label")
        ...
        model.add_argument("--n_wcode", type=int, default=9, help="the number of semantic mask")
        ...
        rendering.add_argument("--n_render", type=int, default=9, help="the number of local semantic 3d generator")
        rendering.add_argument("--depth", type=int, default=3, help='layers in network')
